...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-100 mt-20 text-base-content">
                <div className='flex'>
                    <img className='h-12' src={nikeLogo} alt="" />
                    <p className='font-medium ml-6'>This product is excluded from <br /> site promotions and discounts.</p>
                </div>
                <div>
                ...
                <div>
                    <span className="footer-title font-bold">Menu</span>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-100 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>2022@ farnitureshop all copyright reserved</p>
                </div>
